...
# for paper idea: https://www.sciencedirect.com/science/article/pii/S0924203122001540
# model from: https://github.com/StChenHaoGitHub/1D-deeplearning-model-pytorch/blob/main/DenseNet.py
...
class DenseNet(torch.nn.Module):
    def __init__(self, layer_num=(6, 12, 24, 16),
                 growth_rate=32, init_features=64, in_channels=1, middele_channels=128,
                 classes=5):
...
if __name__ == '__main__':
    input = torch.randn(size=(1, 1, 34526))
    model = DenseNet(layer_num=(6, 12, 24, 16), growth_rate=32, in_channels=1, classes=3)
    output = model(input)
    print(output.shape)
