...
# print(allspot)
# print(max(allspot), min(allspot))
# print(gm1df['Spot index'].values)
# # print(np.where(corRegID==4)[0])
# # if all(df4['Spot index'].values == np.where(corRegID == 6)[0]):
...
# gmxCor = xCor[allspot]
# gmyCor = yCor[allspot]
# for x_, y_ in zip(gmxCor, gmyCor):
#     img[x_, y_] = 1
#
# plt.imshow(img)
# plt.show()
...
pcScores = pca.fit_transform(regSpecLeveled)
